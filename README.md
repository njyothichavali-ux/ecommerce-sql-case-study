...
UK employers — especially in retail, fintech, and consulting — consistently test SQL in interviews and expect candidates to go beyond basic SELECT queries. This project demonstrates the ability to:

- Translate business questions into correct, efficient SQL
- Use advanced features: CTEs, window functions (LAG, DENSE_RANK, SUM OVER), CASE expressions, NULLIF, STDDEV
- Derive actionable insight from query output — not just return data
- Structure analysis in a way that a non-technical stakeholder can follow
...
*This project is part of a data analytics portfolio built to demonstrate real-world SQL competency for UK graduate analyst roles.*
